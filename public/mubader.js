    ...
    <footer>
      <div class="container">
        ...
        <div class="foot-bottom">
          <div>© 2026 مبادر — منصة وطنية محايدة · جميع الحقوق محفوظة</div>
          <div class="site-credits">تم إنشاء هذا الموقع عن طريق <b>زكريا نانيس</b>، وتحت إشراف <b>أمين الغرياني</b></div>
        </div>
      </div>
    </footer>`;
  }
